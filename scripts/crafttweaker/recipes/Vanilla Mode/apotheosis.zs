...
mods.recipestages.Recipes.addShaped("vanilla_mode", "vanilla_ap_nether_bookshelf", <item:apotheosis:hellshelf>,
	[[ING.nether_bricks, ING.nether_bricks, ING.nether_bricks],
	[ING.blaze_rod, ING.bookshelf, ING.pointRegeneration],
	[ING.nether_bricks, ING.nether_bricks, ING.nether_bricks]]);
